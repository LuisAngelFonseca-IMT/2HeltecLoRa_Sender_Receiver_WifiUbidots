...
// Define WIFI KEYs & Ubidots Keys
const char *UBIDOTS_TOKEN = "BBFF-VP9WFkpIa5w3Q8l0jEjneZ5JoQzIxv";  
const char *WIFI_SSID = "WIFI FONSECA";     
const char *WIFI_PASS = "fonseca22";    
const char *DEVICE_LABEL = "martina";
const char *VARIABLE_LABEL = "new-variable"; 
